...
3日以内にご返信がない場合届いていない可能性がありますので、
大変お手数ですが、aakoshiyo@gmail.comまで直接ご連絡をください。
...
?>
	...
	<head>
		<meta charset="UTF-8" />
		<title>お問い合わせ|Arihiro Web Design</title>
	...
	<body>
		<header>
			<div id="nav1">
				<a href="index.html">
					<h1><img src="img/logo.png" alt="Arihiro" id="logo" /></h1>
				</a>
				<div class="menu">
					<ul>
		...
		<main>
			...
			<footer>
				<p>&copy; arihiro All Rights Reserved.</p>
			</footer>
		</main>
	</body>
